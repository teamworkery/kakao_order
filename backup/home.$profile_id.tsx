...
import type { Route } from "./+types/home.$profile_id";
...
export const loader = async ({ request, params }: MyLoaderArgs) => {
  ...
  if (!profile_id) throw new Response("Not Found", { status: 404 });
...
export const saveOrder = async (
  ...
  if (orderError || !order) {
    throw orderError || new Error("주문 저장 실패");
  }
...
export default function OrderPage({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* 메뉴 리스트 */}
      <div className="max-w-sm mx-auto px-4 py-4 pb-40">
