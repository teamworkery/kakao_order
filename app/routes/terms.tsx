      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-card rounded-xl shadow-sm p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80 leading-relaxed">서비스는 다음과 같은 기능을 제공합니다:</p>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제5조 (이용자의 의무)</h2>
            <p className="text-foreground/80 leading-relaxed">이용자는 다음 행위를 해서는 안 됩니다:</p>
            <ul className="list-disc list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제6조 (주문 및 결제)</h2>
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제7조 (픽업)</h2>
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제8조 (서비스의 중단)</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제9조 (면책조항)</h2>
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제10조 (분쟁 해결)</h2>
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">제11조 (회원 탈퇴 및 자격 상실)</h2>
            <ul className="list-decimal list-inside text-foreground/80 space-y-2 ml-4">
