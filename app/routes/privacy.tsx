  ...
  return (
    <div className="min-h-screen bg-muted/50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="bg-card rounded-xl shadow-sm p-8 space-y-8">
          <p className="text-muted-foreground text-sm">
            시행일: 2024년 1월 1일 | 최종 수정일: 2024년 1월 1일
          </p>

          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">1. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">2. 수집하는 개인정보 항목</h2>
            <p className="text-foreground/80 leading-relaxed">서비스는 다음의 개인정보 항목을 수집합니다:</p>
            <ul className="list-disc list-inside text-foreground/80 space-y-2 ml-4">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">3. 개인정보의 보유 및 이용 기간</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">5. 개인정보의 파기</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">6. 정보주체의 권리·의무 및 행사방법</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">7. 쿠키의 사용</h2>
            <p className="text-foreground/80 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-muted/50 p-4 rounded-lg mt-4">
              <p className="text-foreground/80"><strong>개인정보 보호책임자</strong></p>
              <p className="text-muted-foreground mt-2">이메일: privacy@pojang.one</p>
            </div>
          </section>

          <section className="space-y-4">
            <h2 className="text-xl font-bold text-foreground">9. 개인정보 처리방침 변경</h2>
            <p className="text-foreground/80 leading-relaxed">
